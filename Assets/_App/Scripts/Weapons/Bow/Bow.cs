...
namespace MobaVR.Weapons.Bow
{
    ...
    public class Bow : GrabbableEvents
    {
        ...
        [HideInInspector] public Grabber ClosestGrabber;
        [HideInInspector] public Arrow GrabbedArrow;
        [HideInInspector] public Grabber arrowGrabber; // Which grabber is Grabbing the Arrow
        ...
        public UnityEvent<Arrow, Vector3> OnReleaseArrow;
        ...
        void Update()
        {
            ...
            {
                //GameObject arrow = Instantiate(Resources.Load(ArrowPrefab.name, typeof(GameObject))) as GameObject;
        ...
        bool canGrabArrowFromKnock()
        {
            ...
            ControllerHand hand =
                bowGrabbable.GetControllerHand(bowGrabbable.GetPrimaryGrabber()) == ControllerHand.Left
        ...
        void setKnockPosition()
        {
            ...
            if (IgnoreXPosition)
            {
                ArrowKnock.localPosition = new Vector3(getArrowRest().localPosition.x, ArrowKnock.localPosition.y,
                                                       ArrowKnock.localPosition.z);
            }
            ...
            {
                ArrowKnock.localPosition =
                    new Vector3(ArrowKnock.localPosition.x, ArrowKnock.localPosition.y, initialKnockPosition.z);
            }
        }
        ...
        void checkBowHaptics()
        {
            ...
            DrawDefinition d =
                drawDefs.FirstOrDefault(x => x.DrawPercentage <= DrawPercent && x.DrawPercentage != _lastDrawHaptic);
        ...
        {
            ArrowKnock.localPosition =
                Vector3.Lerp(ArrowKnock.localPosition, initialKnockPosition, Time.deltaTime * 100);
        }
        ...
        protected virtual void alignBow()
        {
            ...
            if (grab != null && grab.BeingHeld)
            {
                if (holdingArrow)
                {
                    ...
                    {
                        BowModel.transform.localRotation = Quaternion.Slerp(
                            BowModel.transform.localRotation, Quaternion.identity, Time.deltaTime * AlignBowSpeed);
                    }
                ...
                {
                    BowModel.transform.localRotation = Quaternion.Slerp(BowModel.transform.localRotation,
                                                                        Quaternion.identity,
                                                                        Time.deltaTime * AlignBowSpeed);
                }
            }
        }
